...
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl2")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "gytdl2")
...
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdl2")
GPYTDL_COMMAND = os.environ.get("GPYTDL_COMMAND", "gpytdl2")
