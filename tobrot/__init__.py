...
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdlp")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "gytdlp")
...
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdlp")
GPYTDL_COMMAND = os.environ.get("GPYTDL_COMMAND", "gpytdlp")
